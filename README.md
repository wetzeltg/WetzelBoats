...
The anchor symbol: ring at top → vertical shank → horizontal stock crossbar → curved arms sweeping down, arc midpoint connecting to shank base.
...
| Flight | Direction | Date | Notes |
|--------|-----------|------|-------|
| AS 1525 | FL → SEA | May 1, 2026 · 9:30 PM | Arrival in Seattle |
| AS 441 | SEA → FL | May 9, 2026 | Departure (time TBD) |
| AS 427 | FL → SEA | May 29, 2026 | Arrival (time TBD) |
| AS 394 | SEA → FL | May 31, 2026 | Departure (time TBD) |
...
2. GitHub Pages deploys within ~60 seconds
...
The tablet has Chrome open to `https://wetzeltg.github.io/WetzelBoats/` installed as a home screen app (Chrome menu → Add to Home Screen). After any update deploys, hard refresh in Chrome to get the latest version.
...
| v4.3 | Blurred backdrop photo display (full photo shown uncropped); photo URL updated |
...
| v3.9 | Dad Joke of the Day when no whale sightings; daddy card condensed |
...
| v3.4 | Wake line colors match hull fill |
| v3.0–3.3 | Wake line width, color, opacity, and length iterations |
